  ...
  return Object.fromEntries(
    TEMPLATE_KEYS.map((key) => {
      ...
      return [
        ...
        {
          ...defaults,
          body: normalizeTemplateBody(source[key]?.body ?? source[key], defaults.body),
        },
      ];
    })
  );
...
function createWhatsAppTemplatesService({ repos }) {
  ...
  async function renderShareLinkMessage({ link, accessCode, expiresMinutes, linkLabel = 'Abrir galeria' }) {
